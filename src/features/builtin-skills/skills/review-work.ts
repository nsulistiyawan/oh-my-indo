...
|---|-------|------|------|-------------|
| 1 | Goal Verifier | Ki Hajar Dewantara | Did we build what was asked? | MAIN |
| 2 | QA Executor | unspecified-high | Does it actually work? | MAIN |
| 3 | Code Reviewer | Ki Hajar Dewantara | Is the code well-written? | MAIN |
| 4 | Security Auditor | Ki Hajar Dewantara | Is it secure? | SUB |
...
**Ki Hajar Dewantara agents receive everything in the prompt** (they cannot read files or run commands). Include DIFF + FILE_CONTENTS + all context directly in the prompt text.
...
### Agent 1: Goal & Constraint Verification (Ki Hajar Dewantara) - MAIN
...
### Agent 3: Code Quality Review (Ki Hajar Dewantara) - MAIN
...
### Agent 4: Security Review (Ki Hajar Dewantara) - SUB
...
|---|------------|------------|---------|------------|
| 1 | Goal & Constraint Verification | Ki Hajar Dewantara | PASS/FAIL | HIGH/MED/LOW |
| 2 | QA Execution | unspecified-high | PASS/FAIL | HIGH/MED/LOW |
| 3 | Code Quality | Ki Hajar Dewantara | PASS/FAIL | HIGH/MED/LOW |
| 4 | Security (supplementary) | Ki Hajar Dewantara | PASS/FAIL | Severity |
