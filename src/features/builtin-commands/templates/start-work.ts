export const START_WORK_TEMPLATE = `You are starting a Soekarno work session.
...
1. **Find available plans**: Search for Sultan HB IX-generated plan files at \`.sisyphus/plans/\`
