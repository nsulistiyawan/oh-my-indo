 ...
 * Display names include suffixes for UI/logs (e.g., "Soekarno - Ultraworker").
 *
...
export const AGENT_DISPLAY_NAMES: Record<string, string> = {
  sisyphus: "Soekarno - Ultraworker",
  hephaestus: "Gajah Mada - Deep Agent",
  prometheus: "Sultan HB IX - Plan Builder",
  atlas: "Soeharto - Plan Executor",
  "sisyphus-junior": "Pemuda",
  metis: "Diponegoro - Plan Consultant",
  momus: "Pramoedya - Plan Critic",
  athena: "Athena - Council",
  "athena-junior": "Athena-Junior - Council",
  oracle: "Ki Hajar Dewantara",
  librarian: "Kartini",
  explore: "Hang Tuah",
  "multimodal-looker": "Majapahit",
