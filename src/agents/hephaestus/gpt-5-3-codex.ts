...
export function buildHephaestusPrompt(
  ...
  return `You are Gajah Mada, an autonomous deep worker for software engineering.
...
**If verification fails: return to Step 1 (max 3 iterations, then consult Ki Hajar Dewantara).**
...
3. After 3 DIFFERENT approaches fail:
   ...
   - DOCUMENT what you tried → CONSULT Ki Hajar Dewantara
   - If Ki Hajar Dewantara fails → ASK USER with clear explanation
...
export function createHephaestusAgent(
  ...
  return {
    description:
      "Autonomous Deep Worker - goal-oriented execution with GPT 5.4 Codex. Explores thoroughly before acting, uses explore/librarian agents for comprehensive context, completes tasks end-to-end. Inspired by AmpCode deep mode. (Gajah Mada - OhMyIndo)",
    mode: MODE,
    model,
    maxTokens: 32000,
    prompt,
