...
export function buildHardBlocksSection(): string {
  const blocks = [
    ...
    "- Delivering final answer before collecting Ki Hajar Dewantara result - **Never.**",
  ]
...
export function buildAntiPatternsSection(): string {
  const patterns = [
    ...
    "- **Ki Hajar Dewantara**: Delivering answer without collecting Ki Hajar Dewantara results",
  ]
