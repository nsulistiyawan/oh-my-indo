...
const TOAST_TITLE = "NEVER Use Soekarno with GPT"
const TOAST_MESSAGE = [
  "Soekarno works best with Claude Opus, and works fine with Kimi/GLM models.",
  "Do NOT use Soekarno with GPT (except GPT-5.4 which has specialized support).",
  "For GPT models (other than 5.4), always use Gajah Mada.",
].join("\n")
