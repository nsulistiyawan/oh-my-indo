...
const TOAST_TITLE = "NEVER Use Gajah Mada with Non-GPT"
const TOAST_MESSAGE = [
  "Gajah Mada is designed exclusively for GPT models.",
  "Gajah Mada is trash without GPT.",
  "For Claude/Kimi/GLM models, always use Soekarno.",
].join("\n")
